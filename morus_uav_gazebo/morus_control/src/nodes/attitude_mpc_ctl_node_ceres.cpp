...
namespace mav_control_attitude {
    ...
    void MPCAttitudeControllerNode::MotorSpeedHeightCallback(const mav_msgs::Actuators &msg) {
      ...
      combined_rotor_command_msg.angular_velocities.push_back(1*msg.angular_velocities[0] +  1*pitch_commands_[2]);
      combined_rotor_command_msg.angular_velocities.push_back(1*msg.angular_velocities[0] + 1*roll_commands_[3]);
      combined_rotor_command_msg.angular_velocities.push_back(1*msg.angular_velocities[0] + 1*pitch_commands_[3]);
      combined_rotor_command_msg.angular_velocities.push_back(1*msg.angular_velocities[0] + 1*roll_commands_[2]);
