#ifndef RMP_PROP_MPC_SOLVER
#define RMP_PROP_MPC_SOLVER
...
class RMS_Prop_MPC : public MPC_SOLVER
{
public:
    RMS_Prop_MPC()=default;
	...
	EIGEN_MAKE_ALIGNED_OPERATOR_NEW
		RMS_Prop_MPC(Matrix<double, num_state_variables, num_state_variables> A, Matrix<double, num_state_variables, num_manipulated_variables>  B,
...
private:
	...
	double residuum, residuum_signal, residuum_state, epsilon,rho, delta, min_residuum, alfa, residuum_old;
