...
#ifndef RMP_PROP_WITH_NESTER_MOMENTUM_MPC_SOLVER
#define RMP_PROP_WITH_NESTER_MOMENTUM_MPC_SOLVER
...
class RMS_Prop_with_Nester_momentum_MPC : public MPC_SOLVER
{
public:
    RMS_Prop_with_Nester_momentum_MPC()=default;
	...
	EIGEN_MAKE_ALIGNED_OPERATOR_NEW
		RMS_Prop_with_Nester_momentum_MPC(Matrix<double, num_state_variables, num_state_variables> A, Matrix<double, num_state_variables, num_manipulated_variables>  B,
			...
			Matrix<double, num_manipulated_variables, num_manipulated_variables> scale_MV, Matrix<double, num_state_variables, num_state_variables> scale_OV, double sampingTime);

	~RMS_Prop_with_Nester_momentum_MPC();
...
private:
	...
	double residuum, residuum_signal, residuum_state, epsilon, rho,alpha, delta, min_residuum, alfa, residuum_old;
