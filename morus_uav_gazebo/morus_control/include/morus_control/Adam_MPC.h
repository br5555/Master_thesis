...
class Adam_MPC : public MPC_SOLVER
{
public:
	...
	EIGEN_MAKE_ALIGNED_OPERATOR_NEW
		Adam_MPC(Eigen::Matrix<double, num_state_variables, num_state_variables> A, Eigen::Matrix<double, num_state_variables, num_manipulated_variables>  B,
			Eigen::Matrix<double, num_state_variables, num_state_variables> Bd, Eigen::Matrix<double, num_state_variables, num_state_variables> Q,
			Eigen::Matrix<double, num_state_variables, num_state_variables> Q_final, Eigen::Matrix<double, num_manipulated_variables, num_manipulated_variables> R,
			Eigen::Matrix<double, num_manipulated_variables, num_manipulated_variables> R_delta,
			Eigen::Matrix<double, num_state_variables, 1> disturbance, int num_params, int pred_horizon, int control_horizon,
			Eigen::Matrix<double, num_manipulated_variables, num_manipulated_variables> scale_MV, Eigen::Matrix<double, num_state_variables, num_state_variables> scale_OV, double sampingTime);
